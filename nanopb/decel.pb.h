...
typedef enum _DECEL_GPIO_MESSAGE_ASK_TYPE {
    ...
    DECEL_GPIO_MESSAGE_ASK_TYPE_SET_DISABLE = 10
...
/* Enumération pour les types de message MCP41010 possibles */
typedef enum _DECEL_ANALOG_IN_message_type {
    DECEL_ANALOG_IN_message_type_ENABLE_ANALOG_IN = 0, /* Demande de définir la valeur du MCP41010 */
    DECEL_ANALOG_IN_message_type_DISABLE_ANALOG_IN = 1 /* Demande de mise hors tension du MCP41010 */
} DECEL_ANALOG_IN_message_type;
...
/* Message pour demander des informations sur le MCP41010 */
typedef struct _DECEL_ANALOG_IN_ASK {
    uint32_t ANALOG_IN_id; /* ID du MCP41010 */
    DECEL_ANALOG_IN_message_type type; /* Type de demande MCP41010 */
} DECEL_ANALOG_IN_ASK;

/* Message pour représenter une entrée analogique lue */
typedef struct _DECEL_ANALOG_IN_ANSW {
    uint32_t ANALOG_IN_id; /* ID de l'entrée analogique */
    uint32_t value; /* Valeur lue */
} DECEL_ANALOG_IN_ANSW;
...
typedef struct _DECEL_DECEL_ASK {
    ...
    union {
        ...
        DECEL_ANALOG_IN_ASK analog_in_ask;
    } msg;
} DECEL_DECEL_ASK;
...
typedef struct _DECEL_DECEL_ANSW {
    ...
    union {
        ...
        DECEL_ANALOG_IN_ANSW analog_in_data; /* Données d'entrée analogique */
        DECEL_ACK ack;
    } msg;
} DECEL_DECEL_ANSW;
...
#define _DECEL_GPIO_MESSAGE_ASK_TYPE_MAX DECEL_GPIO_MESSAGE_ASK_TYPE_SET_DISABLE
#define _DECEL_GPIO_MESSAGE_ASK_TYPE_ARRAYSIZE ((DECEL_GPIO_MESSAGE_ASK_TYPE)(DECEL_GPIO_MESSAGE_ASK_TYPE_SET_DISABLE+1))
...
#define _DECEL_ANALOG_IN_message_type_MIN DECEL_ANALOG_IN_message_type_ENABLE_ANALOG_IN
#define _DECEL_ANALOG_IN_message_type_MAX DECEL_ANALOG_IN_message_type_DISABLE_ANALOG_IN
#define _DECEL_ANALOG_IN_message_type_ARRAYSIZE ((DECEL_ANALOG_IN_message_type)(DECEL_ANALOG_IN_message_type_DISABLE_ANALOG_IN+1))
...
#define DECEL_ANALOG_IN_ASK_type_ENUMTYPE DECEL_ANALOG_IN_message_type
...
#define DECEL_ANALOG_IN_ASK_init_default         {0, _DECEL_ANALOG_IN_message_type_MIN}
#define DECEL_ANALOG_IN_ANSW_init_default        {0, 0}
...
#define DECEL_ANALOG_IN_ASK_init_zero            {0, _DECEL_ANALOG_IN_message_type_MIN}
#define DECEL_ANALOG_IN_ANSW_init_zero           {0, 0}
...
#define DECEL_ANALOG_IN_ASK_ANALOG_IN_id_tag     1
#define DECEL_ANALOG_IN_ASK_type_tag             3
#define DECEL_ANALOG_IN_ANSW_ANALOG_IN_id_tag    1
#define DECEL_ANALOG_IN_ANSW_value_tag           2
...
#define DECEL_DECEL_ASK_analog_in_ask_tag        5
...
#define DECEL_ANALOG_IN_ASK_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   ANALOG_IN_id,      1) \
X(a, STATIC,   SINGULAR, UENUM,    type,              3)
#define DECEL_ANALOG_IN_ASK_CALLBACK NULL
#define DECEL_ANALOG_IN_ASK_DEFAULT NULL

#define DECEL_ANALOG_IN_ANSW_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   ANALOG_IN_id,      1) \
X(a, STATIC,   SINGULAR, UINT32,   value,             2)
#define DECEL_ANALOG_IN_ANSW_CALLBACK NULL
#define DECEL_ANALOG_IN_ANSW_DEFAULT NULL
...
X(a, STATIC,   ONEOF,    MESSAGE,  (msg,analog_in_ask,msg.analog_in_ask),   5)
...
#define DECEL_DECEL_ASK_msg_analog_in_ask_MSGTYPE DECEL_ANALOG_IN_ASK
...
#define DECEL_DECEL_ANSW_msg_analog_in_data_MSGTYPE DECEL_ANALOG_IN_ANSW
...
extern const pb_msgdesc_t DECEL_ANALOG_IN_ASK_msg;
extern const pb_msgdesc_t DECEL_ANALOG_IN_ANSW_msg;
...
#define DECEL_ANALOG_IN_ASK_fields &DECEL_ANALOG_IN_ASK_msg
#define DECEL_ANALOG_IN_ANSW_fields &DECEL_ANALOG_IN_ANSW_msg
...
#define DECEL_ANALOG_IN_ANSW_size                12
#define DECEL_ANALOG_IN_ASK_size                 8
